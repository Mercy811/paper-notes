this paper proposes a novel architecture to oversome the conjectural bottleneck of the traditional encoder-decoder architecture, the use of a fixed-length vector. The new architecture consists of:
...
![architecture of the model mentioned in the paper](neural-macine-translation-by-jointly-learning-to-align-and-translate-image1.jpeg)
